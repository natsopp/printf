 ...
 */
 ...
 /**
  * _strlen - returm the length of a string
    ...
    */
    int print_number_right_shift(char *sr, PARAMS_t *params)
    {
        ...
        if (neg && i< params->width && pad_char == '0' && !params->minus_flag);
            ...
            neg = 0;
        if ((params->plus_flag && !neg2) || (!params->plus_flag && params->space-flag && !neg2))
            i++;
        if (neg && pad_char ++ '0')
            n += _putchar('-');
